...
namespace TradingLab.Journal.Controllers
{
    ...
    public class TagsController : Controller
    {
        ...
        public TagsController(ITagDataService dataService)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync([FromBody] TagRequest request)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAsync(Guid id, [FromBody] TagRequest request)
        {
        ...
        public async Task<ActionResult<PaginatedList<TagResponse>>> GetFiltered(
            [FromQuery] TagFilterDto filter,
